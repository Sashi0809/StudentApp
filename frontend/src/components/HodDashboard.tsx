...
import { Users, UploadCloud, FileText, CheckCircle2, UserPlus, Check, X } from 'lucide-react';
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {teachers.map(teacher => (
              <div key={teacher.id} className="bg-black/30 border border-white/10 rounded-lg p-4 flex items-center gap-4 hover:border-emerald-500/30 transition-colors">
